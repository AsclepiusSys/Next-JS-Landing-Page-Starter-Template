...
const Banner = () => (
    <Section style={{
        ...
        <div style={{
            ...
            <h1 className="text-3xl font-bold">Building the Future of Medical Business</h1>
            <p className="mt-4 text-2xl center">
                Contact us at <a href="mailto:management@AsclepiusSys.com">management@AsclepiusSys.com</a>
            </p>
        </div>
    </Section>
);
